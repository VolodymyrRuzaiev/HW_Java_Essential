package com.task_004_DocumentWorker;
/**
 ...
 * "Документ сохранен в новом формате". В теле метода main() реализуйте возможность
 * приема от пользователя номера ключа доступа pro и exp.
 * Если пользователь не вводит ключ, он может пользоваться только бесплатной версией
 * (создается экземпляр базового класса),
